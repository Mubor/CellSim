...
public class CianoBacteria : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cell.AddComponent<MotionSphere>().Params(Speed, DirectionChange, newDirection, direction);
    ...
    public void SetParams(GameObject obj, string tag, string name, float hp, float scale, bool hasdaughter, bool newdirection, int direction, int daughtercnt)
    {
        //setting params
        cell = obj;
        LocalScale = scale;
