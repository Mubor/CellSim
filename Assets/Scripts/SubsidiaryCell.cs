...
public class SubsidiaryCell : MonoBehaviour
{
    ...
    {
        parentCell = GameObject.Find(parentName);
        //print(parentCell.name + " tag " + parentCell.tag);
        ...
        // print("ChangerX: " + positionChangerX + " |||||ChangerZ: " + positionChangerZ);
        ...
        if (scalebuffer >= 1 && scalebuffer < 1.01)
        {
            if (numPrefab == 0)
                ...
                parentCell.GetComponent<Eukaryote>().ScaleChanger(-1.3f);
    ...
    void Born()
    {
            if (numPrefab == 0)
            {
                subsidiaryCell.AddComponent<Bacteria>().SetParams(subsidiaryCell, subsidiaryCell.tag, "bacteria_" + PlayerPrefs.GetInt("CountBacteria"), 100, 5f, false, true, 0, 0);
            ...
            {
                subsidiaryCell.AddComponent<CianoBacteria>().SetParams(subsidiaryCell, subsidiaryCell.tag, "cianobacteria_" + PlayerPrefs.GetInt("CountCianobacteria"), 80, 3f, false, true, 0, 0);
            ...
            {
                subsidiaryCell.AddComponent<Eukaryote>().SetParams(subsidiaryCell, subsidiaryCell.tag, "eukaryote_" + PlayerPrefs.GetInt("CountEukaryote"), 120, 5f, false, true, 0, numPrefab, 0);
