...
public class GameTool : MonoBehaviour
{
    ...
    void CreateNewObject(Vector3 hit, int numprefab, string tag, string name, int spd, int directionChange, float scale, float hp, int maxHeight)
    {
        ...
        {
            case 0:
                thisObject.AddComponent<Bacteria>().SetParams(thisObject, tag, name, hp, scale, false, true, 0, 0);
                break;
            case 1:
                thisObject.AddComponent<CianoBacteria>().SetParams(thisObject, tag, name, hp, scale, false, true, 0, 0);
                break;
            case 2:
                thisObject.AddComponent<Virus>().SetParams(thisObject, tag, name, hp, true, 0);
                break;
        }
    }
